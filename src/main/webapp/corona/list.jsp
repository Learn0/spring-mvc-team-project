        ...
        <div class="row margin-bottom-40">
          ...
          <div class="col-md-12">
            ...
            <div class="content-page">
              <div class="row">
                <form method="get" action="../corona/list.do?addr2=${addr2 }&vaccine=${vaccine}">
               ...
               <table class="table" border="1">
                 ...
                 <tr>
                   <td class="text-center" width=35%>
                    <form method="post" action="../corona/choice.do?orgcd=${vo.orgcd}">
                ...
                <div class="col-md-8 col-sm-8">
                  <ul class="pagination pull-right">
                    <c:if test="${startPage>1 }">
		              <li><a href="../corona/list.do?addr2=${addr2 }&vaccine=${vaccine}&page=${startPage-1 }">« </a></li>
		            </c:if>
                   
                    <c:forEach var="i" begin="${startPage }" end="${endPage }" >
                     <li><a href="../corona/list.do?addr2=${addr2 }&vaccine=${vaccine}&page=${i }">${i }</a></li>
                    </c:forEach>
                    <c:if test="${endPage<totalpage }">
		              <li><a href="../corona/list.do?addr2=${addr2 }&vaccine=${vaccine}&page=${endPage+1 }"> »</a></li>
		            </c:if>
